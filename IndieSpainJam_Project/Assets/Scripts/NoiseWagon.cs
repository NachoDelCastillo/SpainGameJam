...
/// </summary>
public class NoiseWagon : MonoBehaviour
{
    /// <summary>
    ...
    void Update()
    {
        ...
        transform.localPosition = new Vector3(initialPosition.x + (ruidoX * noiseMultiplier / 2), initialPosition.y + (ruidoY * noiseMultiplier * 3), 0);
        #endregion
